...
export default class Teamtailor {
    ...
    e.company || e.apiKey
      ? this.s(this.o(e), (t) => {
          ...
          if (
            ...
            a.insertBefore(s, n)
            e.companySelect && this.J('companies', a, e)
            e.departmentSelect &&
              !e.preselectedDepartment &&
              this.J('departments', a, e)
            e.roleSelect && this.J('roles', a, e)
            e.regionSelect && this.J('regions', a, e)
            e.locationSelect &&
              !e.preselectedLocation &&
              this.J('locations', a, e)
            e.languageSelect &&
              !e.preselectedLanguage &&
              this.J('career-sites', a, e)
            e.remoteStatusSelect && this.J('remote_statuses', a, e)
          }
        })
    ...
    if (!window.TEAMTAILOR_JOB_SCRIPT_LOADED) {
      ...
      for (
        ...
        this.init({
          ...
          companySelect: e[t].getAttribute(
            'data-teamtailor-group-company-select'
          ),
          departmentSelect: e[t].getAttribute(
          ...
          preselectedDepartment: e[t].getAttribute(
          ...
          remoteStatusSelect: e[t].getAttribute(
  ...
  private static _(e) {
    const t = this.m(e)
    return t ? this.g('span', 'teamtailor-jobs__department', t) : null
  }
      ...
      for (let i = 0; i < r.length; i++) {
        r[i].type === 'departments'
          ...
          : r[i].type === 'roles'
            ...
            : r[i].type === 'locations'
              ? (this.a[r[i].id] = r[i])
              : r[i].type === 'regions' && (this.n[r[i].id] = r[i])
      }
    }
  }
  ...
  private static d(e) {
    ...
    return (
      t ||
      (e.relationships && e.relationships.locations.data
  ...
  private static f(e) {
    return e.relationships && e.relationships.regions.data
  ...
  private static h(e) {
    const t = this.p(e)
    return t ? this.g('span', 'teamtailor-jobs__role', t) : null
  }
  private static j(e) {
    const t = this.d(e)
    return t ? this.g('span', 'teamtailor-jobs__location', t) : null
  }
  ...
  private static k(e, t, a, n) {
    const r = this.g('a', `teamtailor-jobs__pagination__${e}`, a.meta.texts[e])
    return (
  ...
  private static p(e) {
    if (e.relationships && e.relationships.role.data) {
  ...
  private static S(e, t) {
    ...
    return a && t.remoteStatusSelect
      ? this.g('span', 'teamtailor-jobs__remote_status', a)
      : null
  }
  ...
  private static v(e) {
    ...
    return t ? this.g('span', 'teamtailor-jobs__company', t) : null
  }
  private static w(e, t) {
    const a = e.title || e.attributes.title,
      n = this.g('a', 'teamtailor-jobs__job-title', a)
    let r = this.T(e, t)
      ? e.links['careersite-job-internal-url']
  ...
  private static y(e) {
    const t = this.f(e)
    return t ? this.g('span', 'teamtailor-jobs__region', t) : null
  }
}
